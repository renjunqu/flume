...
public class ReliableTaildirEventReader implements ReliableEventReader {
    ...
    public List<Long> updateTailFiles(boolean skipToEnd) throws IOException {
        ...
        Iterator<Entry<Long, TailFile>> iter = tailFiles.entrySet().iterator();
        while (iter.hasNext()) {
            Entry<Long, TailFile> entry = iter.next();
    ...
    public static class Builder {
        ...
        public ReliableTaildirEventReader build() throws IOException {
            return new ReliableTaildirEventReader(filePaths, headerTable, positionFilePath,
