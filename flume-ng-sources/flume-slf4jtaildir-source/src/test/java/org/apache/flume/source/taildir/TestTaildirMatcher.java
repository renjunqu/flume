...
import org.apache.flume.source.slf4jtaildir.Slf4jTaildirMatcher;
...
public class TestTaildirMatcher {
  ...
  public void getMatchingFiles() throws Exception {
    ...
    Slf4jTaildirMatcher tm = new Slf4jTaildirMatcher("f1",
  ...
  public void testEmtpyDirMatching() throws Exception {
    Slf4jTaildirMatcher tm = new Slf4jTaildirMatcher("empty",
  ...
  public void testNoMatching() throws Exception {
    Slf4jTaildirMatcher tm = new Slf4jTaildirMatcher(
        "nomatch",
  ...
  public void testNonExistingDir() {
    Slf4jTaildirMatcher tm = new Slf4jTaildirMatcher("exception", "/abracadabra/doesntexist/.*",
                                           isCachingNeeded);
  }
  ...
  public void testDirectoriesAreNotListed() throws Exception {
    ...
    Slf4jTaildirMatcher tm = new Slf4jTaildirMatcher("f1", tmpDir.getAbsolutePath() + File.separator + ".*",
                                           isCachingNeeded);
    List<String> files = filesToNames(tm.getMatchingFiles());
  ...
  public void testRegexFileNameFiltering() throws IOException {
    ...
    Slf4jTaildirMatcher tm1 = new Slf4jTaildirMatcher("ab",
                                            tmpDir.getAbsolutePath() + File.separator + "[ab].log",
                                            isCachingNeeded);
    // Tail files that starts with c.log
    Slf4jTaildirMatcher tm2 = new Slf4jTaildirMatcher("c",
