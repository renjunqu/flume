...
import org.apache.flume.source.slf4jtaildir.ReliableSlf4jTaildirEventReader;
import org.apache.flume.source.slf4jtaildir.Slf4jTailFile;
...
import static org.apache.flume.source.slf4jtaildir.Slf4jTaildirSourceConfigurationConstants.BYTE_OFFSET_HEADER_KEY;
...
public class TestTaildirEventReader {
  ...
  private ReliableSlf4jTaildirEventReader getReader(Map<String, String> filePaths,
      Table<String, String, String> headerTable, boolean addByteOffset) {
    ReliableSlf4jTaildirEventReader reader;
    try {
      reader = new ReliableSlf4jTaildirEventReader.Builder()
          .filePaths(filePaths)
  ...
  private ReliableSlf4jTaildirEventReader getReader(boolean addByteOffset) {
  ...
  private ReliableSlf4jTaildirEventReader getReader() {
  ...
  public void testBasicReadFiles() throws IOException {
    ...
    ReliableSlf4jTaildirEventReader reader = getReader();
  ...
  public void testLoadPositionFile() throws IOException {
    ...
    ReliableSlf4jTaildirEventReader reader = getReader();
    Map<Long, Slf4jTailFile> tailFiles = reader.getTailFiles();
  ...
  public void testByteOffsetHeader() throws IOException {
    ...
    ReliableSlf4jTaildirEventReader reader = getReader(true);
