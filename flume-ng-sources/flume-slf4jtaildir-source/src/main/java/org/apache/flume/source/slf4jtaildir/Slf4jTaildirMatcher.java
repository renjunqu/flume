 ...
 *
 * @see Slf4jTaildirSource
 * @see ReliableSlf4jTaildirEventReader
 * @see Slf4jTaildirSourceConfigurationConstants
 */
@InterfaceAudience.Private
@InterfaceStability.Evolving
public class Slf4jTaildirMatcher {
    private static final Logger                logger                 = LoggerFactory
        .getLogger(Slf4jTaildirMatcher.class);
     ...
     * @see Slf4jTaildirSourceConfigurationConstants
     */
    public Slf4jTaildirMatcher(String fileGroup, String filePattern, boolean cachePatternMatching) {
    ...
    public List<File> getMatchingFiles() {
        long now = TimeUnit.SECONDS
            .toMillis(TimeUnit.MILLISECONDS.toSeconds(System.currentTimeMillis()));
    ...
    public String toString() {
        return "{" + "filegroup='" + fileGroup + '\'' + ", filePattern='" + filePattern + '\''
    ...
    public boolean equals(Object o) {
        ...
        Slf4jTaildirMatcher that = (Slf4jTaildirMatcher) o;
